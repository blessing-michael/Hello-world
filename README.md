...
- git clone git@github.com:blessing-michael/Hello-world.git
...
- select open with liver server(ensure that you have liver server extension downloaded)
...
I would like to thank Abel for his contributions
